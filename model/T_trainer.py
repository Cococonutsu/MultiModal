...
class Text_trainer():
    def __init__(self):
        ...
        self.model = Text_Encoder(MOSI_config).to(self.device)
    ...
    def train(self):
        ...
        while True:
            ...
            for batch in tqdm(self.train_loader):
                ...
                reg_result, train_loss = self.model(texts_tokens, text_masks, labels, "d")
    ...
    def _eval(self):
        ...
        with torch.no_grad(): 
            for batch in tqdm(self.valid_loader):
                ...
                reg_result, valid_loss = self.model(texts_tokens, text_masks, labels)
