...
class Vision_trainer():
    def __init__(self):
        ...
        self.model = Vision_Encoder(MOSI_config).to(self.device)
    ...
    def train(self):
        ...
        while True:
            ...
            for batch in tqdm(self.train_loader):
                mp4_file_paths = batch["mp4_file_paths"]
                labels = batch["labels"].to(self.device)



                
                reg_result, train_loss  = self.model(mp4_file_paths, labels)
    ...
    def _eval(self):
        ...
        with torch.no_grad(): 
            for batch in tqdm(self.valid_loader):
                ...
                reg_result, valid_loss  = self.model(mp4_file_paths, labels)
